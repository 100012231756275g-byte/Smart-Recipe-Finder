...
function SearchComponent() {
  ...
  const filteredRecipes = useMemo(() => {
    ...
    // 0. ค้นหาคำหลาย Token จากชื่อเมนูและวัตถุดิบ
    ...
    // 2. ตรวจสอบรูปแบบการทานอาหาร (Diet)
    ...
    // 3. ระบบ STRICT FILTERING ตาม 5 หมวดเป้าหมาย + โรคประจำตัว
    result = result.filter((recipe) => {
