...
const nutritionDB: Record<string, { cal: number; protein: number; fat: number; carb: number; unit: string; baseAmount: number; category: string }> = {
  ...
  "ปีกไก่": { cal: 220, protein: 24, fat: 13, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "สันในหมู": { cal: 143, protein: 26, fat: 3.5, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "สันนอกหมู": { cal: 198, protein: 24, fat: 11, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "หมูสับ": { cal: 260, protein: 17, fat: 21, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "หมูสามชั้น": { cal: 518, protein: 9.3, fat: 53, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "หมูกรอบ": { cal: 560, protein: 14, fat: 54, carb: 2, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  "ซี่โครงหมู": { cal: 277, protein: 20, fat: 21, carb: 0, unit: "กรัม", baseAmount: 100, category: "เนื้อสัตว์ & โปรตีน" },
  ...
  "เนื้อปู / ปูม้า": { cal: 83, protein: 18, fat: 1, carb: 0, unit: "กรัม", baseAmount: 100, category: "อาหารทะเล" },
  "ปลากะพง": { cal: 97, protein: 20, fat: 1.3, carb: 0, unit: "กรัม", baseAmount: 100, category: "อาหารทะเล" },
  "ปลาแซลมอน": { cal: 208, protein: 20, fat: 13, carb: 0, unit: "กรัม", baseAmount: 100, category: "อาหารทะเล" },
  "ปลาทูสด": { cal: 140, protein: 20, fat: 6, carb: 0, unit: "กรัม", baseAmount: 100, category: "อาหารทะเล" },
  ...
  "ไข่เค็ม": { cal: 140, protein: 8, fat: 10, carb: 1.5, unit: "ฟอง", baseAmount: 1, category: "ไข่ & นม & แปรรูป" },
  "เต้าหู้ขาวแข็ง": { cal: 76, protein: 8, fat: 4.8, carb: 1.9, unit: "กรัม", baseAmount: 100, category: "ไข่ & นม & แปรรูป" },
  "เต้าหู้ไข่": { cal: 65, protein: 5.5, fat: 3.2, carb: 3, unit: "หลอด", baseAmount: 1, category: "ไข่ & นม & แปรรูป" },
  "ลูกชิ้นหมู / ลูกชิ้นเนื้อ": { cal: 160, protein: 12, fat: 8, carb: 10, unit: "กรัม", baseAmount: 100, category: "ไข่ & นม & แปรรูป" },
  "ลูกชิ้นปลา": { cal: 100, protein: 13, fat: 1.5, carb: 8, unit: "กรัม", baseAmount: 100, category: "ไข่ & นม & แปรรูป" },
  "กุนเชียง": { cal: 380, protein: 15, fat: 28, carb: 18, unit: "กรัม", baseAmount: 100, category: "ไข่ & นม & แปรรูป" },
  ...
  "เส้นก๋วยเตี๋ยว / เส้นใหญ่": { cal: 160, protein: 2, fat: 1.5, carb: 35, unit: "กรัม", baseAmount: 100, category: "ข้าว & เส้น & แป้ง" },
  "เส้นเล็ก / เส้นหมี่": { cal: 150, protein: 3, fat: 0.5, carb: 33, unit: "กรัม", baseAmount: 100, category: "ข้าว & เส้น & แป้ง" },
  ...
  "ผักกวางตุ้ง": { cal: 13, protein: 1.5, fat: 0.2, carb: 2.2, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "ผักบุ้ง": { cal: 19, protein: 2.6, fat: 0.2, carb: 3.1, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "แครอท": { cal: 41, protein: 0.9, fat: 0.2, carb: 10, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "แตงกวา": { cal: 15, protein: 0.7, fat: 0.1, carb: 3.6, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "มะเขือเทศ": { cal: 18, protein: 0.9, fat: 0.2, carb: 3.9, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "ถั่วงอก": { cal: 30, protein: 3, fat: 0.2, carb: 5.9, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "ฟักทอง": { cal: 26, protein: 1, fat: 0.1, carb: 6.5, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "เห็ดฟาง / เห็ดนางฟ้า": { cal: 32, protein: 3.5, fat: 0.4, carb: 4.5, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "เห็ดหอม / เห็ดออรินจิ": { cal: 38, protein: 3, fat: 0.3, carb: 6.8, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "เห็ดเข็มทอง": { cal: 37, protein: 2.7, fat: 0.3, carb: 7.8, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "ถั่วฝักยาว": { cal: 47, protein: 2.8, fat: 0.4, carb: 8, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  "หน่อไม้": { cal: 27, protein: 2.6, fat: 0.3, carb: 5.2, unit: "กรัม", baseAmount: 100, category: "ผัก & สมุนไพร" },
  ...
  "น้ำตาลทราย": { cal: 48, protein: 0, fat: 0, carb: 12, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "น้ำตาลปี๊บ": { cal: 60, protein: 0, fat: 0, carb: 15, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "น้ำปลา": { cal: 10, protein: 1.5, fat: 0, carb: 0.5, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "ซอสหอยนางรม": { cal: 15, protein: 0.5, fat: 0.2, carb: 3, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "ซีอิ๊วขาว": { cal: 8, protein: 1, fat: 0, carb: 1, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "ซีอิ๊วดำ": { cal: 25, protein: 0.8, fat: 0, carb: 5.5, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "เต้าเจี้ยว": { cal: 25, protein: 2, fat: 1, carb: 2.5, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
  "กะปิ": { cal: 20, protein: 3, fat: 0.5, carb: 1, unit: "ช้อนโต๊ะ", baseAmount: 1, category: "เครื่องปรุง & ไขมัน" },
...
// 🌟 ฟังก์ชันย่อขนาดและบีบอัดรูปภาพฝั่งเบราว์เซอร์ เพื่อไม่ให้เกินขีดจำกัด Vercel 4.5MB
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        // บีบอัดภาพเป็น JPEG คุณภาพ 75% ขนาดจะเหลือเพียง 100-300 KB
...
export default function CalculatePage() {
  ...
  const analyzeFoodImage = async () => {
    ...
    try {
      // บีบอัดภาพก่อนส่ง API ป้องกัน Error ข้ามเน็ตมือถือและขีดจำกัดขนาดไฟล์ Vercel
