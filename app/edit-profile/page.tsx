...
// 🌟 ขยายรายการโรคประจำตัว (ครอบคลุม NCDs, ระบบทางเดินอาหาร และหลอดเลือด)
...
// 🌟 ขยายรายการแพ้อาหาร (ครอบคลุมสารก่อภูมิแพ้อาหารมาตรฐานสากล)
...
export default function EditProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // ✅ เด้งกลับไปที่หน้า /profile หลัก
      router.push("/profile");
    } catch (error: unknown) {
